...
{   
    ...
    Eigen::Vector2f v12 = _v[1].head(2) - _v[0].head(2);
    Eigen::Vector2f v23 = _v[2].head(2) - _v[1].head(2);
    Eigen::Vector2f v31 = _v[0].head(2) - _v[2].head(2);
    
    Eigen::Vector2f v1p = p - _v[0].head(2);
    Eigen::Vector2f v2p = p - _v[1].head(2);
    Eigen::Vector2f v3p = p - _v[2].head(2);
    
    //using cross prducts to judge p point is inside or outside
    return v12[0] * v1p[1] - v12[1] * v1p[0] > 0
        && v23[0] * v2p[1] - v23[1] * v2p[0] > 0
        && v31[0] * v3p[1] - v31[1] * v3p[0] > 0;
